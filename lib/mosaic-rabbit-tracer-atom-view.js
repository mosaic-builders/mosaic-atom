...
export default class MosaicRabbitTracerAtomView {

  constructor(serializedState) {
    // Create root element
    this.element = document.createElement('div');
    this.element.classList.add('mosaic-rabbit-tracer-atom');

    // Create message element
    const message = document.createElement('div');
    message.textContent = 'The MosaicRabbitTracerAtom package is Alive! It\'s ALIVE!';
  ...
  serialize() {
    return {
      ...
      // across all packages
      deserializer: 'mosaic-rabbit-tracer-atom/MosaicRabbitTracerAtomView'
    };
  }

  getTitle() {
    // used by Atom for tab text
    return 'Rabbit Tracer Helper'
  }

  getURI() {
    // used by Atom to identify the view when toggling
    return 'atom://mosaic-rabbit-tracer-atom'
  }
